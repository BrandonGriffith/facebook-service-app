...
const Home = (props: Props) => {
  ...
  if (!guestLogin) if (!props.session) return <Login setGuestLogin={setGuestLogin} />
  return (
    <div className="h-screen overflow-y-hidden bg-slate-100">
      ...
      <Header guestLogin={guestLogin} setGuestLogin={setGuestLogin} />
      <main className='flex'>
        <Sidebar guestLogin={guestLogin} />
        <UserFeed guestLogin={guestLogin} updatePosts={updatePosts} setUpdatePosts={setUpdatePosts} />
        <Widgets />
      </main>
    </div>
  )
